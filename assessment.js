 ...
 * @return {string} 診断結果
 */
function assesment(userNmae){
    //　全文字のコード番号を取得して足し合わせる
    let sumOfCharCode=0; //letは{}で囲まれた利用に限るためvarより安全
    for(let i=0; i<userNmae.length; i++){
        sumOfCharCode=sumOfCharCode+userNmae.charCodeAt(i);
    }
